...
const SignUpScreen = () => {
    ...
    createUserWithEmailAndPassword(auth, email, password).then((userCredential)=>{
      //For create account log reference, usually won't apply log in workplace
  ...
  return (
    ...
    <Text style={{...styles.subTitle}} allowFontScaling={false}>Sign up to create an account</Text>
       ...
       <View style={styles.buttonContainer}>
        ...
        <Text style={{marginTop: height*0.02, ...styles.signText}}>ALREADY HAVE AN ACCOUNT?</Text>
        <Text style={{...styles.signText}}>LOGIN NOW!</Text>
        </TouchableOpacity>
